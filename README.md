![Michael Harms — Software Engineer](https://hxms-ten.vercel.app/banner)

# Hi, I'm Michael Harms

> Full-stack engineer (React · Next.js · TypeScript) shipping performant web apps and AI-powered products end to end.
...
- **Senior Product Engineer** at **Moonscale** — Built the real-time AI sales-call interface and contributed to enterprise client integrations the team delivered for ~250k€ in revenue.
- **Experienced Software Engineer** at **Joyn** — Led the web side of a cross-platform subscription rebuild that saved ~10–20k€/month, on a streaming platform with ~4M monthly active users.
- **Senior Frontend Engineer** at **Lateral** — Migrated the frontend to Next.js and engineered a grid-based text-selection algorithm for an AI research reader serving ~1,000 users.
- **Frontend Engineer** at **ApoSync** — Owned the internal CMS web UI for a pharmacy app with 10,000+ users, plus the company website and transactional/marketing email templates.
